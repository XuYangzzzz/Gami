...
enum AIType     { WALKER, GUARD, CHARGER, JUMPER, GUARD_DOWN, BOUNCER           };
enum AIState    { WALKING, IDLE, ATTACKING, CHARGING, RECHARGING, JUMPING,BOUNCING };
...
public:
    ...
    bool const check_collision_bottom(Entity other);
    ...
    void ai_guard_down(Entity *player);
    void ai_bounce(Entity *player);



    
    void normalise_movement() { m_movement = glm::normalize(m_movement); }
    bool const facing_right() const{return facingright;};
    void face_left() { m_animation_indices = m_walking[LEFT]; facingleft = true; facingright = false;}
    void face_right() { m_animation_indices = m_walking[RIGHT]; facingright =true; facingleft = false; }
    ...
    // ————— GETTERS ————— //
    bool const get_shoot() const {return shoot;};
    ...
    // ————— SETTERS ————— //
    void const set_shoot(bool a){shoot = a;};
